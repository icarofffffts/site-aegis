  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Aegis — Proteção avançada para sua comunidade" },
      {
        ...
        content:
          "Bot de moderação e segurança premium para Discord, com arquitetura multi-plataforma.",
      },
    ],
  }),
  component: HomePage,
...
const FEATURES = [
  {
    icon: Shield,
    title: "Anti-Raid avançado",
    desc: "Detecção em tempo real de ataques coordenados, com lockdown automático e mitigação inteligente.",
  },
  {
    icon: Zap,
    title: "Anti-Spam instantâneo",
    desc: "Filtros adaptativos contra flood, menções em massa, links maliciosos e contas descartáveis.",
  },
  {
    icon: Eye,
    title: "Auto-Mod inteligente",
    desc: "Regras personalizáveis com ações automáticas: avisos, mute, kick ou ban — tudo sob seu controle.",
  },
  {
    icon: Activity,
    title: "Logs detalhados",
    desc: "Registro completo de ações de moderação, edições, deleções e entradas com histórico pesquisável.",
  },
  {
    icon: Users,
    title: "Verificação de membros",
    desc: "Captcha e verificação progressiva para barrar bots antes que eles cheguem aos seus canais.",
  },
  {
    icon: Lock,
    title: "Permissões granulares",
    desc: "Configure quem pode usar cada comando com base em cargos, canais ou contexto.",
  },
];
...
const STEPS = [
  {
    n: "01",
    title: "Adicione o Aegis",
    desc: "Convide o bot ao seu servidor com um clique e permissões mínimas.",
  },
  {
    n: "02",
    title: "Configure em minutos",
    desc: "Painel guiado de configuração — anti-raid, logs e auto-mod prontos.",
  },
  {
    n: "03",
    title: "Proteja sua comunidade",
    desc: "Aegis monitora 24/7 e aplica as regras que você definiu, automaticamente.",
  },
];
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl">
            ...
            <h1 className="mt-8 text-5xl font-bold tracking-tight text-white sm:text-7xl lg:text-8xl">
              Proteção avançada para sua <span className="text-blue-500">comunidade</span>
            </h1>

            <p className="mt-8 max-w-2xl text-xl text-[#7d8590] sm:text-2xl">
              Aegis é o escudo definitivo contra raids, spam e ataques. Moderação automatizada, logs
              profundos e configuração simples — tudo em uma única plataforma.
            </p>
            ...
            <div className="mt-12 flex flex-col items-center gap-4 sm:flex-row">
              <Button
                asChild
                size="lg"
                className="h-14 bg-[#1f883d] px-8 text-lg font-semibold text-white hover:bg-[#1a7a35] border border-[#1f883d]/20 shadow-none"
              >
              ...
              <Button
                ...
                size="lg"
                variant="outline"
                className="h-14 border-[#30363d] bg-transparent px-8 text-lg font-semibold text-white hover:bg-[#161b22] hover:border-[#8b949e]"
              >
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-2 gap-8 px-4 py-16 sm:px-6 md:grid-cols-4 lg:px-8">
          {STATS.map((s, i) => (
            <div key={s.label} className="text-center">
              ...
              <div className="mt-2 text-sm font-medium text-[#7d8590] uppercase tracking-wide">
                {s.label}
              </div>
            </div>
          ))}
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            <h2 className="text-3xl font-bold text-white sm:text-4xl">
              Tudo que sua comunidade precisa para prosperar com segurança
            </h2>
            <p className="mt-4 text-lg text-[#7d8590]">
              Um conjunto robusto de ferramentas de segurança projetado para funcionar
              instantaneamente.
            </p>
          </div>
      ...
      <section className="border-y border-[#30363d] bg-[#161b22]/50">
        <div className="mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-lg text-[#7d8590]">
              Adicione proteção profissional ao seu servidor em menos de 5 minutos.
            </p>
          </div>
      ...
      <section className="bg-[#0d1117] py-24 px-4">
        <div className="mx-auto max-w-5xl overflow-hidden rounded-2xl border border-[#30363d] bg-gradient-to-br from-[#161b22] to-[#0d1117] p-12 sm:p-20 text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-xl text-[#7d8590]">
            Junte-se a mais de 12.000 servidores que confiam no Aegis para manter seus membros
            seguros.
          </p>
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Button
              asChild
              size="lg"
              className="h-14 bg-[#1f883d] px-10 text-lg font-bold text-white hover:bg-[#1a7a35] shadow-none"
            >
              <a href={SITE_URLS.botInvite} rel="noopener">
                Adicionar ao Discord
              </a>
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="h-14 border-[#30363d] bg-transparent px-10 text-lg font-bold text-white hover:bg-[#161b22] hover:border-[#8b949e]"
            >
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-x-8 gap-y-2 text-sm text-[#7d8590]">
            <span className="flex items-center gap-2">
              <CheckCircle2 className="h-4 w-4 text-[#3fb950]" /> Comece grátis
            </span>
            <span className="flex items-center gap-2">
              <CheckCircle2 className="h-4 w-4 text-[#3fb950]" /> Setup instantâneo
            </span>
            <span className="flex items-center gap-2">
              <CheckCircle2 className="h-4 w-4 text-[#3fb950]" /> Suporte 24/7
            </span>
          </div>
        </div>
      </section>
